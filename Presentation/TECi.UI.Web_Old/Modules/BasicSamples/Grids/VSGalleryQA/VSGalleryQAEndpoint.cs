...
namespace TECi.UI.Web.BasicSamples.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class VSGalleryQAController : ServiceEndpoint
    {
        ...
        private List<VSGalleryQAThread> LoadFromLocalCopy()
        {
            ...
            if (!System.IO.File.Exists(path))
            {
                ...
                var bytes = new WebClient().DownloadData("https://github.com/volkanceylan/TECi.UI.Web/raw/master/TECi.UI.Web/TECi.UI.Web.Web/" + 
