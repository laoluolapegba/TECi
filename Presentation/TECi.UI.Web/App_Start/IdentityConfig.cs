...
using System.Web;
using TECi.Data.Identity.Models;
...
namespace TECi.UI.Web
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private async Task configSendGridasync(IdentityMessage message)
        {
            ...
            myMessage.SetFrom(new EmailAddress(ConfigurationManager.AppSettings["mailSender"], ConfigurationManager.AppSettings["maildisplayName"]));
