...
namespace TECi.UI.Web.Extensions
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "TECi.UI.Web.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "TECi.UI.Web.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
